...
public class ModFlammableBlocks {
    public static void registerFlammableBlocks() {
        ...
        registry.add(ModBlocks.BOGWOOD_CEDAR_PLANKS, 5, 20);
        registry.add(ModBlocks.BOGWOOD_CEDAR_LEAVES, 5, 60);
        registry.add(ModBlocks.BOGWOOD_CEDAR_LOG, 5, 5);
        registry.add(ModBlocks.STRIPPED_BOGWOOD_CEDAR_LOG, 5, 5);
        registry.add(ModBlocks.BOGWOOD_CEDAR_WOOD, 5, 5);
        registry.add(ModBlocks.STRIPPED_BOGWOOD_CEDAR_WOOD, 5, 5);
