...
public class ModStrippableBlocks {
    public static void registerStrippableBlocks() {
        ...
        StrippableBlockRegistry.register(ModBlocks.BOGWOOD_CEDAR_LOG, ModBlocks.STRIPPED_BOGWOOD_CEDAR_LOG);
        StrippableBlockRegistry.register(ModBlocks.BOGWOOD_CEDAR_WOOD, ModBlocks.STRIPPED_BOGWOOD_CEDAR_WOOD);
