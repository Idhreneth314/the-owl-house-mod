...
public enum ModArmorMaterials implements ArmorMaterial {
    WITCHS_WOOL("witchs_wool", 15, new int[] { 2, 3, 4, 2 }, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 2.0f, 0.1f, () -> Ingredient.ofItems(Items.LEATHER)),
    COVEN_GUARD("coven_guard", 15, new int[] { 1, 4, 5, 2 }, 12,
