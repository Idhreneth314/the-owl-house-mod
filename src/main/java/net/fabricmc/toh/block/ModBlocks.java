...
public class ModBlocks {
    public static final Block TITANSTONE_SILVER_ORE = registerBlock("titanstone_silver_ore", new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_GOLD_ORE)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block SILVER_ORE = registerBlock("silver_ore", new Block(FabricBlockSettings.copy(Blocks.GOLD_ORE).of(Material.STONE).strength(3.0f).requiresTool()), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block TITANSTONE_GOLD_ORE = registerBlock("titanstone_gold_ore", new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_GOLD_ORE)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block TITANSTONE_IRON_ORE = registerBlock("titanstone_iron_ore", new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block TITANSTONE_COPPER_ORE = registerBlock("titanstone_copper_ore", new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_COPPER_ORE)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOILING_PINE_SAPLING = registerBlock("boiling_pine_sapling", new PlantBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOILING_PINE_TRAPDOOR = registerBlock("boiling_pine_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOILING_PINE_BUTTON = registerBlock("boiling_pine_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON),1, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOILING_PINE_FENCE_GATE = registerBlock("boiling_pine_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOGWOOD_CEDAR_SAPLING = registerBlock("bogwood_cedar_sapling", new PlantBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOGWOOD_CEDAR_DOOR = registerBlock("bogwood_cedar_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CEDAR_TRAPDOOR = registerBlock("bogwood_cedar_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CEDAR_BUTTON = registerBlock("bogwood_cedar_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON),1, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CEDAR_PRESSURE_PLATE = registerBlock("bogwood_cedar_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CEDAR_FENCE_GATE = registerBlock("bogwood_cedar_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PRICKLY_FIR_SAPLING = registerBlock("prickly_fir_sapling", new PlantBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PRICKLY_FIR_TRAPDOOR = registerBlock("prickly_fir_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_BUTTON = registerBlock("prickly_fir_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON),1, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_PRESSURE_PLATE = registerBlock("prickly_fir_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_FENCE_GATE = registerBlock("prickly_fir_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PALISTROM_SAPLING = registerBlock("palistrom_sapling", new PlantBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PALISTROM_TRAPDOOR = registerBlock("palistrom_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_BUTTON = registerBlock("palistrom_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON),1, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_PRESSURE_PLATE = registerBlock("palistrom_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_FENCE_GATE = registerBlock("palistrom_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block WRINKLING_OAK_SAPLING = registerBlock("wrinkling_oak_sapling", new PlantBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block WRINKLING_OAK_TRAPDOOR = registerBlock("wrinkling_oak_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_BUTTON = registerBlock("wrinkling_oak_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON),1, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_PRESSURE_PLATE = registerBlock("wrinkling_oak_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_FENCE_GATE = registerBlock("wrinkling_oak_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    private static Item registerBlockItem(String name, Block block, ItemGroup group) {
        Item item = Registry.register(Registries.ITEM, new Identifier(toh.MOD_ID, name), new BlockItem(block, new FabricItemSettings()));
