...
public class ModBlocks {
    public static final Block TITANSTONE_SILVER_ORE = registerBlock("titanstone_silver_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_GOLD_ORE)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block SILVER_ORE = registerBlock("silver_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.GOLD_ORE).of(Material.STONE).strength(3.0f).requiresTool()), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block TITANSTONE_GOLD_ORE = registerBlock("titanstone_gold_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_GOLD_ORE)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_COAL_ORE = registerBlock("titanstone_coal_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_COAL_ORE), UniformIntProvider.create(3, 5)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_AMETHYST_ORE = registerBlock("titanstone_amethyst_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.AMETHYST_BLOCK), UniformIntProvider.create(3, 5)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_DIAMOND_ORE = registerBlock("titanstone_diamond_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_DIAMOND_ORE), UniformIntProvider.create(3, 5)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_EMERALD_ORE = registerBlock("titanstone_emerald_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_EMERALD_ORE), UniformIntProvider.create(3, 5)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_LAPIS_ORE = registerBlock("titanstone_lapis_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_LAPIS_ORE), UniformIntProvider.create(3, 5)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block TITANSTONE_IRON_ORE = registerBlock("titanstone_iron_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block TITANSTONE_COPPER_ORE = registerBlock("titanstone_copper_ore", new ExperienceDroppingBlock(FabricBlockSettings.copy(Blocks.DEEPSLATE_COPPER_ORE)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOILING_PINE_DOOR = registerBlock("boiling_pine_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOILING_PINE_TRAPDOOR = registerBlock("boiling_pine_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOILING_PINE_BUTTON = registerBlock("boiling_pine_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON), 5, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOILING_PINE_PRESSURE_PLATE = registerBlock("boiling_pine_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOILING_PINE_FENCE_GATE = registerBlock("boiling_pine_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block BOGWOOD_CYPRESS_LOG = registerBlock("bogwood_cypress_log", new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_WOOD = registerBlock("bogwood_cypress_wood", new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_WOOD)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block STRIPPED_BOGWOOD_CYPRESS_LOG = registerBlock("stripped_bogwood_cypress_log", new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_OAK_LOG)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block STRIPPED_BOGWOOD_CYPRESS_WOOD = registerBlock("stripped_bogwood_cypress_wood", new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_OAK_WOOD)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_PLANKS = registerBlock("bogwood_cypress_planks", new Block(FabricBlockSettings.copy(Blocks.OAK_PLANKS)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_LEAVES = registerBlock("bogwood_cypress_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_SAPLING = registerBlock("bogwood_cypress_sapling", new SaplingBlock(new BogwoodCypressSaplingGenerator(), FabricBlockSettings.copy(Blocks.SPRUCE_SAPLING)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_SLAB = registerBlock("bogwood_cypress_slab", new SlabBlock(FabricBlockSettings.copy(Blocks.OAK_SLAB)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_STAIRS = registerBlock("bogwood_cypress_stairs", new StairsBlock( ModBlocks.BOILING_PINE_PLANKS.getDefaultState(),FabricBlockSettings.copy(Blocks.OAK_STAIRS)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_DOOR = registerBlock("bogwood_cypress_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_TRAPDOOR = registerBlock("bogwood_cypress_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_BUTTON = registerBlock("bogwood_cypress_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON), 5, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_PRESSURE_PLATE = registerBlock("bogwood_cypress_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_FENCE_GATE = registerBlock("bogwood_cypress_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_FENCE = registerBlock("bogwood_cypress_fence", new FenceBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE)), ModItemGroup.DEMON_REALM_MISC);
    public static final Block BOGWOOD_CYPRESS_ROOTS = registerBlock("bogwood_cypress_roots", new MangroveRootsBlock(FabricBlockSettings.copy(Blocks.MANGROVE_ROOTS)), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PRICKLY_FIR_DOOR = registerBlock("prickly_fir_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_TRAPDOOR = registerBlock("prickly_fir_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_BUTTON = registerBlock("prickly_fir_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON), 5, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_PRESSURE_PLATE = registerBlock("prickly_fir_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PRICKLY_FIR_FENCE_GATE = registerBlock("prickly_fir_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block PALISTROM_DOOR = registerBlock("palistrom_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_TRAPDOOR = registerBlock("palistrom_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_BUTTON = registerBlock("palistrom_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON), 5, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_PRESSURE_PLATE = registerBlock("palistrom_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block PALISTROM_FENCE_GATE = registerBlock("palistrom_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block WRINKLING_OAK_DOOR = registerBlock("wrinkling_oak_door", new DoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR), SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundEvents.BLOCK_WOODEN_DOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_TRAPDOOR = registerBlock("wrinkling_oak_trapdoor", new TrapdoorBlock(FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR), SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_BUTTON = registerBlock("wrinkling_oak_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON), 5, true, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_OFF, SoundEvents.BLOCK_WOODEN_BUTTON_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_PRESSURE_PLATE = registerBlock("wrinkling_oak_pressure_plate", new PressurePlateBlock( PressurePlateBlock.ActivationRule.EVERYTHING,FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE), SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON), ModItemGroup.DEMON_REALM_MISC);
    public static final Block WRINKLING_OAK_FENCE_GATE = registerBlock("wrinkling_oak_fence_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE), SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), ModItemGroup.DEMON_REALM_MISC);
    ...
    public static final Block EYELIGHT = registerBlock("eyelight", new EyelightModBlock(FabricBlockSettings.copy(Blocks.COBWEB).sounds(BlockSoundGroup.SLIME).luminance(state -> 15)), ModItemGroup.DEMON_REALM_MISC);

    public static final Block FLESH_TENDRILS = registerBlock("flesh_tendrils", new FleshTendrilsModBlock(FabricBlockSettings.copy(Blocks.COBWEB).sounds(BlockSoundGroup.SLIME)), ModItemGroup.DEMON_REALM_MISC);
